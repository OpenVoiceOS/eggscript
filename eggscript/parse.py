...
if __name__ == "__main__":
    ns = EggParser()
    ns.load_ns("/home/user/PycharmProjects/eggscript/dialogs.eggscript")
    #         Intent: hello world
    #         Layer: 1
    ...
    ns.load_ns("/home/user/PycharmProjects/eggscript/layers.eggscript")
    ...
    ns.load_ns("/home/user/PycharmProjects/eggscript/hello.eggscript")
    #         Intent: hello world
    #         Layer: 1
    #         Utterances: ['hello world']
